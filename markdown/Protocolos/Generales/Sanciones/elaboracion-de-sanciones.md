...
> [!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="danger" icon="tools" text="Moderador"](#): Ey, ey, `@usuario`, ya. Paramos con el [_flood_](../../canales-de-texto/conducta-abusiva.md##cascada-de-mensajes-o-flood).<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="danger" icon="tools" text="Moderador"](#): `@usuario`, última advertencia. Deja de mandar tanto mensaje repetitivo, estás inundando el canal.<br>[!badge variant="dark" icon="person" text="Usuario"](#): Ok.<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="dark" icon="person" text="Usuario"](#): POTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTOPOTO<br>[!badge variant="warning" icon="dependabot" text="Bot"](#): Caso #77777, `@usuario` ha sido silenciado por `3 horas`.

{% endtab %}
{% endtabs %}
===

Tras aplicar una advertencia oficial, si el comportamiento continúa, se imposibilita al usuario a hablar, a menos que el caso vaya creciendo de gravedad exponencialmente.
Recomendamos incrementar el valor por tres cada vez que se silencie al infractor, aunque sean casos de distinta naturaleza.
- Empezamos por tres horas, luego lo multiplicamos por tres, obteniendo nueve horas, en la tercera infracción serán veintisiete, y así sucesivamente.

**Acumulación de sanciones**:
Cuando una persona llega a un número elevado de problemas envueltos (entorno a nueve), nosotros los vetamos temporalmente de la comunidad por unas semanas, dependiendo del historial.
Si tras regresar, se le ve con la misma actitud, se convertirá permanente.
...
1. Somos humanos.
2. Tres advertencias y luego una sanción. Tras la primera sanción, se le silencia, incrementando el tiempo exponencialmente cada vez. Cuando llegas a nueve sanciones se ejecuta una de mayor gravedad, dando una última oportunidad.
3. Dejar constancia de todas tus acciones y eliminar todo el contenido que cause un mal ambiente o pueda ser peligroso.
Ejemplo:
> [!badge variant="dark" icon="person" text="Usuario"](#): [lenguaje irrespetuoso]<br>[!badge variant="danger" icon="tools" text="Moderador"](#): [elimina el lenguaje irrespetuoso y da un aviso] 1/3<br>[!badge variant="dark" icon="person" text="Usuario"](#): [lenguaje irrespetuoso]<br>[!badge variant="danger" icon="tools" text="Moderador"](#): [elimina el lenguaje irrespetuoso y da un aviso] 2/3<br>[!badge variant="dark" icon="person" text="Usuario"](#): [lenguaje irrespetuoso]<br>[!badge variant="danger" icon="tools" text="Moderador"](#): [elimina el contenido y da aviso final] 3/3 <br>[!badge variant="dark" icon="person" text="Usuario"](#): [lenguaje irrespetuoso]<br>[!badge variant="warning" icon="dependabot" text="Bot"](#): Advertencia a `@usuario`<br>[!badge variant="dark" icon="person" text="Usuario"](#): [lenguaje irrespetuoso]<br>[!badge variant="warning" icon="dependabot" text="Bot"](#): `@usuario` silenciado por `3 horas`<br>[!badge variant="dark" icon="person" text="Usuario"](#): [continúa con un comportamiento tóxico y haciendo comentarios sexuales, llevándose varias advertencias formales y siendo silenciado unas cuantas veces]<br>[!badge variant="danger" icon="tools" text="Moderador"](#): [ultimátum: puede ser mediante un aviso o siendo vetado temporalmente, dependiendo del criterio del responsable]<br>[!badge variant="dark" icon="person" text="Usuario"](#): [continúa]<br>[!badge variant="warning" icon="dependabot" text="Bot"](#): `@usuario` vetado de manera `permanente`]
===
